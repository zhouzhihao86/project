...
e);var p=this,o=false,c,r,s,w,k,j,h=a(window).height(),g=a(window).width(),n;doresize=true;scroll_pos=x();a(window).unbind("resize.prettyphoto").bind("resize.prettyphoto",function(){t();h=a(window).height();g=a(window).width();typeof $pp_overlay!="undefined"&&$pp_overlay.height(a(document).height()).width(g)});e.keyboard_shortcuts&&a(document).unbind("keydown.prettyphoto").bind("keydown.prettyphoto",function(b){if(typeof $pp_pic_holder!="undefined")if($pp_pic_holder.is(":visible"))switch(b.keyCode){case 37:a.prettyPhoto.changePage("previous");
