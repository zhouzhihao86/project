 ...
 */
@Controller
@RequestMapping(value = "admin/plateChinese")
public class PlateChineseController extends BaseController {
    ...
    public String doAdd(@ModelAttribute("form") PlateChinese plateChinese) {
