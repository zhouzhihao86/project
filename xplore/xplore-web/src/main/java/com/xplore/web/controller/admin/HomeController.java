...
import com.xplore.web.service.permission.AdminService;
...
public class HomeController {
    ...
    public String login(Model model, RedirectAttributes redirectAttribute, HttpSession httpSession, @RequestParam(value = "username", required = false) String username, @RequestParam(value = "password", required = false) String password) {
